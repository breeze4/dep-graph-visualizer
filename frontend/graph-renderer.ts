 ...
 */
function renderGraph(graphData, dragHandlers, nodeClickHandler, nodeHoverHandlers, edgeHandlers, showLinkTooltip, hideLinkTooltip) {
...
function createNodes(g, nodes, nodeClickHandler, nodeHoverHandlers, dragHandlers) {
    ...
    if (nodeHoverHandlers) {
        node.on('mouseenter', nodeHoverHandlers.mouseenter)
